class X2DownloadableContentInfo_ProjectRoswellLDN extends X2DownloadableContentInfo;
...
static function ReworkMelee()
{
    ...
    AbilityTemplate = AbilityTemplateManager.FindAbilityTemplate('BladestormAttack');
...
// Called when the difficulty changes and this DLC/Mod is active
